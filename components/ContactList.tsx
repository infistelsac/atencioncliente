...
const ContactList: React.FC<ContactListProps> = ({ contacts, onUpdateContacts, onStartCall }) => {
  ...
  const handleSyncGoogle = () => {
      ...
      setTimeout(() => {
          ...
          onUpdateContacts([...contacts, ...googleContacts]);
          setIsSyncing(false);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingId) {
        onUpdateContacts(contacts.map(c => c.id === editingId ? contactData : c));
    } else {
        onUpdateContacts([contactData, ...contacts]);
    }
