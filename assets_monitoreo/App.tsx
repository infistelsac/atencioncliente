...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-[#05080f] text-slate-400 overflow-hidden select-none text-[13px]">
      {/* HEADER GLOBAL */}
      {!selectedDevice && (
        <header className="h-16 border-b border-slate-800 bg-slate-900/80 flex items-center justify-between px-6 z-20 shadow-2xl">
      ...
      {/* FOOTER GLOBAL */}
      {!selectedDevice && (
        <footer className="h-8 border-t border-slate-800 bg-slate-950 px-6 flex items-center justify-between text-[8px] text-slate-500 font-mono uppercase tracking-[0.4em]">
          <div className="flex items-center gap-6">
